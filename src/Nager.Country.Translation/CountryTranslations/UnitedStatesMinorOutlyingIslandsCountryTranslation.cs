namespace Nager.Country.Translation.CountryInfos
{
    ...
    public class UnitedStatesMinorOutlyingIslandsCountryTranslation : ICountryTranslation
    {
        public TranslationInfo[] Translations => new[]
        {
            ...
            new TranslationInfo(LanguageCode.BS, "Američka Vanjska Ostrva"),
            ...
            new TranslationInfo(LanguageCode.KO, "미국령 군소 제도"),
            new TranslationInfo(LanguageCode.KY, "АКШнын сырткы аралдары"),
            new TranslationInfo(LanguageCode.LT, "Jungtinių Valstijų Mažosios Tolimosios Salos"),
            new TranslationInfo(LanguageCode.LV, "ASV Mazās Aizjūras salas"),
