namespace Nager.Country.Translation.CountryInfos
{
    ...
    public class DominicanRepublicCountryTranslation : ICountryTranslation
    {
        ...
        public TranslationInfo[] Translations => new []
        {
            ...
            new TranslationInfo(LanguageCode.EL, "Δομινικανή Δημοκρατία"),
            new TranslationInfo(LanguageCode.EN, "Dominican Republic"),
            new TranslationInfo(LanguageCode.ES, "República Dominicana"),
            new TranslationInfo(LanguageCode.ET, "Dominikaani Vabariik"),
            ...
            new TranslationInfo(LanguageCode.KK, "Доминикан Республикасы"),
            ...
            new TranslationInfo(LanguageCode.SK, "Dominikánska republika"),
            new TranslationInfo(LanguageCode.SL, "Dominikanska republika"),
            new TranslationInfo(LanguageCode.SR, "Доминиканска Република"),
            new TranslationInfo(LanguageCode.SV, "Dominikanska republiken"),
