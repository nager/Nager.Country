namespace Nager.Country.Translation.CountryInfos
{
    ...
    public class PalestineCountryTranslation : ICountryTranslation
    {
        ...
        public TranslationInfo[] Translations => new []
        {
            ...
            new TranslationInfo(LanguageCode.CS, "Palestinská autonomie"),
            new TranslationInfo(LanguageCode.DA, "Palæstina"),
            new TranslationInfo(LanguageCode.DE, "Staat Palästina"),
            new TranslationInfo(LanguageCode.EL, "Κράτος της Παλαιστίνης"),
            new TranslationInfo(LanguageCode.EN, "Palestinian Territory, Occupied"),
            new TranslationInfo(LanguageCode.ES, "Palestina"),
            new TranslationInfo(LanguageCode.ET, "Palestiina ala"),
            new TranslationInfo(LanguageCode.FA, "سرزمین‌های فلسطینی"),
            ...
            new TranslationInfo(LanguageCode.PT, "Territórios palestinos"),
            new TranslationInfo(LanguageCode.RO, "Teritoriile Palestiniene"),
            new TranslationInfo(LanguageCode.RU, "Государство Палестина"),
            new TranslationInfo(LanguageCode.SK, "Palestínske územia"),
            new TranslationInfo(LanguageCode.SL, "Palestinsko ozemlje"),
            new TranslationInfo(LanguageCode.SR, "Палестинске територије"),
            new TranslationInfo(LanguageCode.SV, "Palestinska territoriet, ockuperade"),
            new TranslationInfo(LanguageCode.TR, "Filistin Bölgeleri"),
