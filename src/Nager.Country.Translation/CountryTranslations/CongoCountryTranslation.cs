namespace Nager.Country.Translation.CountryTranslations
{
    ...
    /// DR Congo
    /// </summary>
    public class CongoCountryTranslation : ICountryTranslation
    {
        /// <inheritdoc/>
        public TranslationInfo[] Translations => new []
        {
            new TranslationInfo(LanguageCode.AR, "الكونغو"),
            ...
            new TranslationInfo(LanguageCode.CA, "Congo, República Democràtica del"),
            new TranslationInfo(LanguageCode.CS, "DR Kongo"),
            new TranslationInfo(LanguageCode.DA, "Demokratiske Republik Congo"),
            new TranslationInfo(LanguageCode.DE, "Kongo (Dem. Rep.)"),
            new TranslationInfo(LanguageCode.EL, "Λαϊκή Δημοκρατία του Κονγκό"),
            new TranslationInfo(LanguageCode.EN, "DR Congo"),
            new TranslationInfo(LanguageCode.ES, "Congo (Rep. Dem.)"),
            new TranslationInfo(LanguageCode.ET, "Kongo DV"),
            new TranslationInfo(LanguageCode.FA, "کنگو دموکراتیک"),
            new TranslationInfo(LanguageCode.FI, "Kongon demokraattinen tasavalta"),
            new TranslationInfo(LanguageCode.FR, "Congo (Rép. dém.)"),
            new TranslationInfo(LanguageCode.HE, "קונגו-קינשאסה"),
            new TranslationInfo(LanguageCode.HI, "कांगो लोकतांत्रिक गणराज्य"),
            new TranslationInfo(LanguageCode.HR, "Kongo, Demokratska Republika"),
            ...
            new TranslationInfo(LanguageCode.IT, "Congo (Rep. Dem.)"),
