namespace Nager.Country.Translation.CountryInfos
{
    ...
    public class SouthGeorgiaCountryTranslation : ICountryTranslation
    {
        ...
        public TranslationInfo[] Translations => new []
        {
            ...
            new TranslationInfo(LanguageCode.BG, "Южна Джорджия и Южни Сандвичеви острови"),
            ...
            new TranslationInfo(LanguageCode.SL, "Južna Georgia in Južni Sandwichevi otoki"),
            new TranslationInfo(LanguageCode.SR, "Јужна Џорџија и Јужна Сендвичка Острва"),
            new TranslationInfo(LanguageCode.SV, "Sydgeorgien och Sydsandwichöarna"),
            new TranslationInfo(LanguageCode.TR, "Güney Georgia ve Güney Sandwich Adaları"),
