namespace Nager.Country.Translation.CountryInfos
{
    ...
    public class VaticanCityCountryTranslation : ICountryTranslation
    {
        public TranslationInfo[] Translations => new []
        {
            ...
            new TranslationInfo(LanguageCode.BS, "Vatikan"),
            new TranslationInfo(LanguageCode.CA, "Vaticà, Ciutat del"),
            new TranslationInfo(LanguageCode.CS, "Vatikán"),
            ...
            new TranslationInfo(LanguageCode.RO, "Statul Cetății Vaticanului"),
            new TranslationInfo(LanguageCode.RU, "Ватикан"),
            new TranslationInfo(LanguageCode.SK, "Vatikán"),
            new TranslationInfo(LanguageCode.SL, "Vatikan"),
            new TranslationInfo(LanguageCode.SR, "Ватикан"),
            new TranslationInfo(LanguageCode.SV, "Vatikanstaten"),
            new TranslationInfo(LanguageCode.TR, "Vatikan"),
