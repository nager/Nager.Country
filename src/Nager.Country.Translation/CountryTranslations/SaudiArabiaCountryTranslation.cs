namespace Nager.Country.Translation.CountryInfos
{
    ...
    public class SaudiArabiaCountryTranslation : ICountryTranslation
    {
        ...
        public TranslationInfo[] Translations => new []
        {
            ...
            new TranslationInfo(LanguageCode.BG, "Саудитска Арабия"),
            new TranslationInfo(LanguageCode.BS, "Saudijska Arabija"),
            new TranslationInfo(LanguageCode.CA, "Aràbia Saudita"),
            new TranslationInfo(LanguageCode.CS, "Saúdská Arábie"),
            new TranslationInfo(LanguageCode.DA, "Saudi-Arabien"),
            ...
            new TranslationInfo(LanguageCode.RO, "Arabia Saudită"),
            new TranslationInfo(LanguageCode.RU, "Саудовская Аравия"),
            new TranslationInfo(LanguageCode.SK, "Saudská Arábia"),
            new TranslationInfo(LanguageCode.SL, "Saudova Arabija"),
            new TranslationInfo(LanguageCode.SR, "Саудијска Арабија"),
            new TranslationInfo(LanguageCode.SV, "Saudiarabien"),
