namespace Nager.Country.Translation.CountryInfos
{
    ...
    public class TurksAndCaicosIslandsCountryTranslation : ICountryTranslation
    {
        ...
        public TranslationInfo[] Translations => new []
        {
            ...
            new TranslationInfo(LanguageCode.BG, "острови Търкс и Кайкос"),
            new TranslationInfo(LanguageCode.BS, "Ostrva Turks i Kaikos"),
            ...
            new TranslationInfo(LanguageCode.RO, "Insulele Turks și Caicos"),
            new TranslationInfo(LanguageCode.RU, "Теркс и Кайкос"),
            new TranslationInfo(LanguageCode.SK, "Turks a Caicos"),
            new TranslationInfo(LanguageCode.SL, "Otoki Turks in Caicos"),
            new TranslationInfo(LanguageCode.SR, "Острва Туркс и Каикос"),
            new TranslationInfo(LanguageCode.SV, "Turks- och Caicosöarna"),
            new TranslationInfo(LanguageCode.TR, "Turks ve Caicos Adaları"),
