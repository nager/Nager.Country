...
namespace Nager.Country.CountryInfos
{
    ...
    /// Brazil
    /// </summary>
    public sealed class BrazilCountryInfo : ICountryInfo
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public ICurrency[] Currencies => [CurrencyProvider.Brl];

        /// <inheritdoc/>
        public string[] CallingCodes => ["55"];
    }
}
